                                            ...
                                            {record.details.results && record.details.results.length > 0 && (
                                                <div style={{ marginTop: '0.5rem' }}>
                                                    {record.details.results.map(r => (
                                                        <a key={r.id} href={`http://localhost:3001/${r.filePath}`} target="_blank" rel="noreferrer" style={{ display: 'block', color: 'var(--primary)', textDecoration: 'none', fontSize: '0.9rem', marginBottom: '4px' }}>
